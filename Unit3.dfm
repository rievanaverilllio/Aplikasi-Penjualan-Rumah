object DataAdmin: TDataAdmin
  ...
  object filter2: TSMDBFilterDialog
    Caption = 'Filter setup dialog'
    Dataset = zqry2
    FilterMode = fmFilterDataset
    WildCard = '%'
  ...
  object export2: TmxDBGridExport
    DateFormat = 'dd/MM/yyyy'
    TimeFormat = 'hh:mm'
    DateTimeFormat = 'hh:mm dd/MM/yyyy'
    ExportType = xtExcel
  ...
  object filter3: TSMDBFilterDialog
    Caption = 'Filter setup dialog'
    Dataset = zqry3
    FilterMode = fmFilterDataset
    WildCard = '%'
  ...
  object export3: TmxDBGridExport
    DateFormat = 'dd/MM/yyyy'
    TimeFormat = 'hh:mm'
    DateTimeFormat = 'hh:mm dd/MM/yyyy'
    ExportType = xtExcel
